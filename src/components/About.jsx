...
import aboutImg from '../assets/about-housing.png';
      ...
      <div className="about-container">
        ...
        <div className="about-image-column">
          <div className="about-image-wrapper">
            <img src={aboutImg} alt="FRP Membrane Housing" className="about-img" />
          </div>
        </div>
        ...
        <div className="about-content-column">
          ...
          {/* Main Section Title with Word-by-Word Scroll Reveal Animation */}
          <ScrollReveal
            tag="h2"
