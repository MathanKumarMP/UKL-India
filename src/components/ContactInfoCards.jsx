    ...
    <section className="contact-info-section">
      <div className="contact-info-container">
        ...
        <div className="contact-card">
          ...
          <div className="card-body">
            <div className="card-icon-box">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000ff" strokeWidth="2.2">
        ...
        <div className="contact-card">
          ...
          <div className="card-body">
            <div className="card-icon-box">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#040404ff" strokeWidth="2.2">
        ...
        <div className="contact-card">
          ...
          <div className="card-body">
            <div className="card-icon-box">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#070707ff" strokeWidth="2.2">
